...
from .models import Choice, Topping, Sicilian, Size, Regular, Cart, RegularItem, SicilianItem, Pasta, Sub, SubItem, SubTopping
# Register your models here.

class CartAdmin(admin.ModelAdmin):
    filter_horizontal = ("regulars", "sicilians", "subs")
